								...
								<tbody class="jobBody">
									<c:forEach items="${contents}" var="content">
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/edit-content/${content.contentId}">Edit</a>|
												<a class="delete"
												href="${pageContext.request.contextPath}/view-content/delete/${content.contentId}">Delete</a>
